  ...
  <div class="wrap">
    ...
    <div class="cat-grid">
      ...
      <a class="cat-card" href="/catalog?cat=1">
        <img class="cat-image" src="/assets/img/cakes/cake_1_0.jpg" alt="Торты" loading="lazy" decoding="async">
      ...
      <a class="cat-card" href="/catalog?cat=2">
        <img class="cat-image" src="/assets/img/cakes/cake_1_1.jpg" alt="Пирожные" loading="lazy" decoding="async">
      ...
      <a class="cat-card" href="/catalog?cat=3">
        <img class="cat-image" src="/assets/img/cakes/cake_1_2.jpg" alt="Капкейки" loading="lazy" decoding="async">
